  ...
  constructor(private platform: Platform,
    ...
    private databaseProvider: DatabaseProvider) {
      ...
      this.platform.ready().then(() => {
        ...
        //subscripe topic, aplikasi akan menerima notif berdasarkan topi yang dikirim
        //bagian ini bisa kita isi dengan id setiap user agar server dapat mengirim notif
        //pada user tertentu
